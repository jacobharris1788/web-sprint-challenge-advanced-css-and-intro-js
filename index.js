...
// --Note-- I can't for the life of me figure out what they want me to do here. No array methods seem usable at all in this situation.
// I used .includes() which is an array method just so I could have an array method in my code. 

if (artists[8].name.includes("Dough") == true) {
...
function get20s(array){
  let newArray = array.filter(array => array.years.substr(0,4) > 1900 && array.years.substr(7,4) < 2000);
...
addArtist(artists, {id:20, name: "Jacob Harris", years: "1990 - 2020", genre: "Web Design", nationality: "Jewish", bio: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras porttitor."});
...
function lotsOfArt(array){
  let newArray = array.filter(array => array.paintings >= 100);
  return newArray;
}
